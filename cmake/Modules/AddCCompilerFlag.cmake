...
macro(ADD_C_COMPILER_FLAG)
	if (NOT ${ARGC})
		...
		foreach(_flag ${ARGV})
			foreach(_build IN ITEMS "" "_DEBUG" "_RELEASE" "_MINSIZEREL" "_RELWITHDEBINFO")
				list(FIND CMAKE_C_FLAGS${_build} "${_flag}" _found)
				if (_found EQUAL -1)
					set(CMAKE_C_FLAGS${_build} "${CMAKE_C_FLAGS${_build}} ${_flag}")
				endif()
				unset(_found)
			endforeach()
		endforeach()
